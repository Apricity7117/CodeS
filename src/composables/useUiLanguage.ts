...
const zhCN: Record<string, string> = {
  ...
  'Save catalog': '保存目录',
  'Codex CLI': 'Codex CLI',
  'Restart Codex CLI': '重启 Codex CLI',
  'Restarting…': '正在重启…',
  'Confirm restart': '确认重启',
  'Click again to restart Codex CLI. Running turns and pending requests will be interrupted.': '再次点击以重启 Codex CLI。运行中的轮次和待处理请求会被中断。',
  'Codex CLI restarted.': 'Codex CLI 已重启。',
  'Failed to restart Codex CLI': '重启 Codex CLI 失败',
  'models': '个模型',
  'hidden': '已隐藏',
  '{count} more': '还有 {count} 个',
  'Choose an available model before sending': '发送前请选择可用模型',
  'Selected model is hidden. Choose an available model before sending.': '所选模型已隐藏。发送前请选择可用模型。',
  'Reasoning': '推理',
  ...
  'Changed files': '已更改文件',
  'Modified files': '文件已修改',
  '1 file changed': '1 个文件已修改',
  '{count} files changed': '{count} 个文件已修改',
  ...
  'Archive thread': '归档线程',
  'Archive thread?': '归档线程？',
  'This will archive the thread "{title}". You can find it later in archived threads.': '这会归档线程“{title}”。稍后可在已归档线程中找到它。',
  'This will permanently delete the thread "{title}" from disk. It cannot be restored in Codex CLI.': '这会从磁盘中永久删除线程“{title}”。之后无法在 Codex CLI 中恢复。',
  'Delete project sessions': '删除项目会话',
  'Delete project sessions?': '删除项目会话？',
  'This will permanently delete all sessions for project "{name}" from disk. Project files will not be deleted.': '这会从磁盘中永久删除项目“{name}”的所有会话。项目文件不会被删除。',
  'Name': '名称',
  'Prompt': '提示词',
  'Search prompt...': '搜索提示词...',
  'Status': '状态',
  ...
  'Loading Git state': '正在加载 Git 状态',
  'Detached HEAD': 'Detached HEAD',
  'Current branch': '当前分支',
  'Local changes present': '存在本地变更',
  'Working tree clean': '工作区干净',
  'Codex app-server bridge': 'Codex app-server 桥接',
