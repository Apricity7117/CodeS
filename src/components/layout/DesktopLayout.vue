...
.desktop-layout {
  @apply grid overflow-hidden transition-colors;
  background-color: var(--codex-surface-under);
...
.desktop-resize-handle {
  @apply relative w-px cursor-col-resize bg-transparent transition-colors;
}
...
.desktop-main {
  @apply min-h-0 overflow-y-hidden overflow-x-visible transition-colors;
  background-color: var(--codex-bg);
  border-top-left-radius: var(--codex-radius-lg);
  border-bottom-left-radius: var(--codex-radius-lg);
  box-shadow: var(--codex-main-surface-shadow);
  overflow: hidden;
  position: relative;
  z-index: 1;
}

.desktop-layout.is-mobile .desktop-main {
  border-radius: 0;
  box-shadow: none;
}
