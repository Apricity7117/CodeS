...
import { IconCodexFolder, IconCodexWorktree } from '../icons/codex'
...
const options = [
  { value: 'local' as const, label: t('Local project'), icon: IconCodexFolder },
  { value: 'worktree' as const, label: t('New worktree'), icon: IconCodexWorktree },
]
