<template>
  <svg width="1em" height="1em" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    <path d="M7.5 12.5L10 10L12.5 12.5" stroke="currentColor" stroke-width="1.33" stroke-linecap="round" stroke-linejoin="round" />
    <path d="M10 10.5V17" stroke="currentColor" stroke-width="1.33" stroke-linecap="round" stroke-linejoin="round" />
  </svg>
</template>
